...
<?php 
$sql="select `start_stamp`,`caller_id_number`,`destination_number`,`start_stamp`,end_stamp, billsec,`hangup_cause`,`account_code` from cdr where length(destination_number)>4 and length(caller_id_number)=4 and date(start_stamp)>='$fecha1' and date(start_stamp)<='$fecha2' ORDER BY  `cdr`.`start_stamp` desc";
$ret=$db->query($sql);
?>
...
<audio controls class="embed-responsive-item">
	<!-- source src="<?php echo substr($row["account_code"],22) ?>" -->
