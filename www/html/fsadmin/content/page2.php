...
<?php 
$sql="select `start_stamp`,`caller_id_number`,`destination_number`,`start_stamp`,end_stamp, billsec,`hangup_cause`,account_code from cdr where date(start_stamp)>='$fecha1' and date(start_stamp)<='$fecha2' ORDER BY  `cdr`.`start_stamp` desc ";
//echo $sql;
$ret=$db->query($sql);
?>
