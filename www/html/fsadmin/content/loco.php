...
<?php 
$sql="select distinct(`start_stamp`),`caller_id_number`,`destination_number`,`start_stamp`,end_stamp, billsec,`hangup_cause` from cdr where date(start_stamp)>='$fecha1' and date(start_stamp)<='$fecha2' and hangup_cause='NORMAL_CLEARING' and context='urbanas' ORDER BY  `cdr`.`start_stamp` desc limit 100";
$ret=$db->query($sql);
?>
